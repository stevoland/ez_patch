...
class eZNewsletter extends eZPersistentObject
{
    ...
    static function definition()
    {
        return array( 'fields' => array( 'id' => array( 'name' => 'ID',
                                         ...
                                         'output_format' => array( 'name' => 'OutputFormat',
                                                                   ...
                                                                   'default' => '',
                                                                   'required' => true ),
                                         'template_to_use' => array( 'name' => 'TemplateToUse',
                                                                     'datatype' => 'string',
                                                                     'default' => '',
                                                                     'required' => true ),
    ...
    */
    function generateNewsletter( $format = eZNewsletter::OutputFormatText, $sendPreview = false )
    {
        ...
        if ( $tpl->hasVariable( 'imageFileList' ) &&
             $format == eZNewsletter::OutputFormatHTML )
        {
    ...
    */
    ...
    function copy( $frontendcopy = false )
    {
        ...
        $newNewsletter->setAttribute( 'template_to_use', $this->attribute( 'template_to_use' ) );
